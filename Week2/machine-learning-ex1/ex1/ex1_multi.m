...
% try different values of learning rate theta
alpha1 = 0.01
[theta1, J_history1] = gradientDescentMulti(X, y, theta_init, alpha1, num_iters);
alpha2 = 0.001
[theta2, J_history2] = gradientDescentMulti(X, y, theta_init, alpha2, num_iters);

% Plot the convergence graph for each value of theta
figure;
